...
public class AplikasiBiodata extends JFrame {
    ...
    public AplikasiBiodata() {
        ...
        textFieldNama.setBackground(new Color(255, 228, 225));
        ...
        textFieldNomorHP.setBackground(new Color(255, 240, 245));
        ...
        buttonHapus.setBackground(new Color(255, 235, 215));
        ...
        buttonSimpan.setBackground(new Color(250, 235, 215));
